      ...
      {tab === 'prompts' && (
        <div>
          <form onSubmit={handleCreatePrompt} className="bg-white border border-gray-200 rounded-lg p-4 mb-4">
            ...
            <textarea
              value={newPromptText}
              onChange={e => setNewPromptText(e.target.value.slice(0, 300))}
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <span className={`text-xs ${newPromptText.length > 280 ? 'text-red-500' : 'text-gray-400'}`}>
                {newPromptText.length}/300
              </span>
            </div>
          </form>
