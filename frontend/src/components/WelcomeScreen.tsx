      ...
      <div className="retro-panel p-8 max-w-md w-full relative">
        ...
        <div className="flex items-end justify-center mt-6 gap-2">
          ...
          <div className="relative mb-3">
            <Link to="/host" className="group inline-block relative bg-yellow-300 text-black text-[9px] font-bold px-3 py-1.5 rounded-lg uppercase tracking-wider hover:bg-do-orange transition-colors">
